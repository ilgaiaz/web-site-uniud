    ...
    <body>
        ...
        <div id="container-mod-data" class="container">
            <div class="jumbotron">
                ...
                <input type="text" id="myInput" class="tab_input" onkeyup="search('myInput','products-table',1)" placeholder="Cerca per nome componente.." title="Type in a name">
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    ?>
                                        ...
                                        <td class="prod-name"><?php echo $name[$i] ;?></td>
                                            <td class="prod-spec-<?php echo $ind[$i];?>" style="display: none"><?php echo utf8_encode($descr[$i]) ;?></td>
